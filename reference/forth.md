...
Now I want to see something more entertaining so I'll write a little Forth program to make the LED flash. A non-Forther might think of this as defining keyboard macros.
...
`MS` stands for milliseconds and kills time, thus `500 MS` kills about 1/2 a second. If you don't have that word in your Forth system, you can define it with something like
...
The following code loads under Pygmy Forth running on a PC to create a memory image on the PC of the 3-instruction Forth to be run on the 68HC11. It assumes a 68HC11 assembler has already been loaded on top of Pygmy.
...
Hex dump of the 66-byte monitor:
